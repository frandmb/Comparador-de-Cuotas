...
const App = () => {
  const [inflation, setInflation] = createSignal(6.3); // No encontré API pública para pullearlo actualizado, ref publicación: https://www.indec.gob.ar/indec/web/Nivel4-Tema-3-5-31
